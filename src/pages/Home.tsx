    ...
    <div className="space-y-20">
      ...
      <section className="py-12 md:py-20">
        ...
        >
          ...
          <motion.p variants={item} className="max-w-3xl text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <motion.div variants={item} className="flex flex-wrap gap-4 pt-4">
            ...
            <a 
              ...
              className="px-6 py-3 rounded-lg border border-gray-300 dark:border-gray-700 hover:border-gray-400 dark:hover:border-gray-600 text-gray-700 dark:text-gray-300 font-medium transition-colors"
            >
              View Github
            </a>
          </motion.div>
            ...
            <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800">
              ...
              <div className="flex flex-wrap gap-2">
                {resumeData.skills.languages_and_systems.map(skill => (
                  <span key={skill} className="px-3 py-1 bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-gray-300 rounded-full text-sm">
                    {skill}
                  </span>
                ))}
              </div>
